...
@server.add_method '/live/name/clip' do |message|
  ...
  colorize_clip clip_info[0], clip_info[1], clip_info[2]
end
...
/live/name/clip         (int track, int clip, string name, int color)   Sets clip number clip in track number track's name to name and color to color
